...
export default class PostTourView extends Component {
  ...
  render() {
    ...
    // console.log("asdasdasda", this.props.data);
    ...
    return (
      <View style={styles.container}>
        ...
        <View>
          ...
          <ImageButtonView image={Images.tour_name} title={title} bold />
          <ImageButtonView image={Images.tour_calendar} title={date_tour} />
          {
            showMore
              ...
              <View>
                ...
                {/* <ImageButtonView onPress={this.onPressDebounce} underline image={Images.tour_location} title={location_text} /> */}
                ...
                <ImageButtonView image={Images.ic_time_schedule_max} title={deadline_timer} />
              </View>
