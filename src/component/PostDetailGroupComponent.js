...
export default class PostDetailGroupComponent extends Component {
    ...
    doLikePostNotification = (comment_id) => {

        // request
        this.props.likePostNotification(comment_id)
            .then(data => {
    ...
    doCreateComment = (data) => {
        ...
        if (this.props.data && this.props.data.isNotifycation) {
            ...
            this.props.createCommentNotification(data)
                .then(comment => {
            ...
            this.props.createCommentGroup(data)
                .then(comment => {
                    let postDetail = this.state.postDetail
                    postDetail.total_comments++;
                    // console.log('chấm ren com ment', comment);
    ...
    onPressLikeButton = () => {
        ...
        if (this.props.data && this.props.data.isNotifycation) {
            ...
            this.doLikePostNotification(comment_id)
        } else {
