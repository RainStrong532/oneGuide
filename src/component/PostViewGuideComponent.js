...
class PostViewGuideComponent extends Component {
                ...
                <View style={{ flex: 1, backgroundColor: '#fff', marginTop: 5, padding: 10 }} >
                        ...
                        <View >
                            <TouchableOpacity style={styles.container_flexDirection}>
                                ...
                                <View style={{ marginLeft: 7, marginTop: 2 }}>
                                    <Text style={{ fontWeight: '600', fontSize: 16 }}>Guide</Text>
                    ...
                    <View style={{ marginTop: 5 }}>
                        ...
                        <View style={styles.flexDirection}>
                            <Image resizeMode='contain' source={Images.tour_calendar}></Image>
                            <Text style={styles.marginLeft}>Thiếu</Text>
                        </View>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='contain' source={Images.tour_location}></Image>
...
export default PostViewGuideComponent;
