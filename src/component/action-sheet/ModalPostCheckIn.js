...
import { showModalPostCheckIn } from '../../navigation'
class ModalComment extends Component {
    ...
    renderImage = async () => {
        this.props.callback.passProps()
        return dimissOverlay(this.props.componentId)
    }
    nextPostImage = async () => {
        showModalPostCheckIn()
        return dimissOverlay(this.props.componentId)
                        ...
                        <View style={{
                            ...
                            >
                                ...
                                <Text style={[styles.text]}>
                                    {i18next.t('PostPicture')}

                                </Text>
                            </TouchableOpacity>
                            {checkShowImage.length === 0 ? null :
                                <TouchableOpacity
                                    style={[styles.button_left]}
