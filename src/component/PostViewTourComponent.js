...
class PostViewTourComponent extends Component {
                ...
                <View style={{ flex: 1, backgroundColor: '#fff', marginTop: 5, padding: 10 }} >
                        ...
                        <View >
                            <TouchableOpacity style={styles.container_flexDirection}>
                                ...
                                <View style={{ marginLeft: 7, marginTop: 2 }}>
                                    <Text style={{ fontWeight: '600', fontSize: 16 }}>Tuor</Text>
                    ...
                    <View style={{ marginTop: 5 }}>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='contain' source={Images.tour_name}></Image>
                            <Text style={styles.marginLeft}>Thiếu</Text>
                        </View>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='center' source={Images.tour_calendar}></Image>
                            <Text style={styles.marginLeft}>Thiếu</Text>
                        </View>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='center' source={Images.tour_location}></Image>
                            <Text style={styles.marginLeft}>{dataPost.location}</Text>
                        </View>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='contain' source={Images.tour_language}></Image>
                            <Text style={styles.marginLeft}>{dataPost.language}</Text>
                        </View>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='contain' source={Images.tour_experience}></Image>
                            <Text style={styles.marginLeft}>{dataPost.experience}</Text>
                        </View>
                        <View style={styles.flexDirection}>
                            <Image resizeMode='center' source={Images.tour_deadline}></Image>
                            <Text style={styles.marginLeft}>{dataPost.deadline_timer}</Text>
                        </View>
...
export default PostViewTourComponent;
