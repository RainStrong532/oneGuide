...
export default class PostDetailHomeGroup extends Component {
    ...
    doCreateComment = (data) => {
        ...
        // request
        this.props.createCommentHomeGroup(data)
            .then(comment => {
    ...
    render() {
        ...
        // console.log('sờ tết post detail', this.state);
        // console.log("PostDetailHomeGroup");
